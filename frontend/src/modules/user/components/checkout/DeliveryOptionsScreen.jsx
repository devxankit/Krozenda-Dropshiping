...
import { HiArrowLeft, HiMapPin, HiCheck, HiTruck } from 'react-icons/hi2'
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center justify-between bg-white p-4 rounded-2xl border border-slate-200/80 shadow-xs">
              <div className="flex items-center space-x-3">
                ...
                <h1 className="text-lg md:text-xl font-black text-slate-900">Choose Shipping Speed</h1>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200/80 p-4 shadow-xs flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs font-bold text-slate-900">Rahul Sharma - 123, Sunrise Apartments, SG Highway, Ahmedabad</p>
                </div>
              </div>
              <button onClick={onChangeAddress} className="text-xs font-bold text-blue-600 hover:underline shrink-0 ml-2">
                Change Address
              </button>
            </div>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-start space-x-3">
                        <div className={`w-5 h-5 rounded-full border flex items-center justify-center mt-0.5 ${isSelected ? 'border-blue-600 bg-blue-600' : 'border-slate-300'}`}>
