...
export function Screen24InvoiceDownload({ onBack = () => {}, onDownload = () => {} }) {
  return (
    <div className="w-full min-h-screen bg-slate-50 flex flex-col justify-between text-slate-800 font-sans">
      ...
      <div className="flex-1 pb-20 md:pb-12 max-w-3xl mx-auto w-full md:px-6 md:py-6">
        ...
        <div className="p-4 space-y-4">
          <div className="bg-white rounded-2xl border p-5 shadow-xs space-y-3 text-xs">
            <h3 className="text-sm font-black">Tax Invoice</h3>
            <p>INV-KRO-1234567890</p>
          </div>
          <button onClick={onDownload} className="w-full bg-blue-600 text-white font-bold py-3.5 rounded-xl text-xs flex items-center justify-center space-x-2">
