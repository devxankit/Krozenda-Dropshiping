...
export function Screen3OtpInput({
  ...
  return (
    <div className="w-full min-h-screen bg-slate-100 flex flex-col md:flex-row font-sans">
      ...
      <DesktopLeftShowcase
        title="2-Step Verification for Ultimate Security"
        subtitle="Protecting your account and transactions with encrypted OTP verification."
