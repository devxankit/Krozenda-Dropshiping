  ...
  return (
    <div className="w-full min-h-screen bg-slate-50 flex flex-col justify-between p-6 text-slate-800 font-sans text-center">
      <div className="my-auto space-y-6">
        ...
        <p className="text-xs text-slate-500 max-w-xs mx-auto">You have logged in successfully.</p>
        <button onClick={() => { onNext(); navigate(USER_ROUTES.DASHBOARD); }} className="w-full bg-blue-600 text-white font-bold py-3.5 rounded-xl text-xs">Go to Dashboard</button>
      </div>
    </div>
  )
}
