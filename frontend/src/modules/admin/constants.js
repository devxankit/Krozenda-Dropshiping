...
export const NAV_TREE = Object.freeze([
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: 'Transactions',
        to: ADMIN_ROUTES.TRANSACTIONS,
        icon: 'finance',
        permission: ADMIN_PERMISSIONS.FINANCE_VIEW,
      },
      {
        label: 'Refunds',
        to: ADMIN_ROUTES.REFUNDS,
        icon: 'finance',
        permission: ADMIN_PERMISSIONS.FINANCE_VIEW,
      },
      {
      ...
      },
      {
        ...
        to: ADMIN_ROUTES.VENDOR_LEDGERS,
        icon: 'finance',
        permission: ADMIN_PERMISSIONS.FINANCE_VIEW,
      },
      {
      ...
      },
      {
        ...
        to: ADMIN_ROUTES.CHART_OF_ACCOUNTS,
        icon: 'finance',
        permission: ADMIN_PERMISSIONS.FINANCE_MANAGE,
      },
      {
        label: 'Journal vouchers',
        to: ADMIN_ROUTES.JOURNAL_VOUCHERS,
        icon: 'finance',
        permission: ADMIN_PERMISSIONS.FINANCE_MANAGE,
      },
      {
        label: 'Expenses',
        to: ADMIN_ROUTES.EXPENSES,
        icon: 'finance',
        permission: ADMIN_PERMISSIONS.FINANCE_MANAGE,
      },
      {
      ...
      {
        label: 'Balance sheet',
        to: ADMIN_ROUTES.BALANCE_SHEET,
        icon: 'finance',
        permission: ADMIN_PERMISSIONS.FINANCE_VIEW,
      },
      {
        label: 'Trial balance',
        to: ADMIN_ROUTES.TRIAL_BALANCE,
        icon: 'finance',
        permission: ADMIN_PERMISSIONS.FINANCE_VIEW,
      },
      {
        label: 'Cash flow',
        to: ADMIN_ROUTES.CASH_FLOW,
        icon: 'finance',
        permission: ADMIN_PERMISSIONS.FINANCE_VIEW,
      },
      {
