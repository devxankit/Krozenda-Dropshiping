...
export const SCREEN_GROUPS = Object.freeze([
  ...
  },
  {
    ...
    screens: [
      ...
      { to: ADMIN_ROUTES.SUB_ORDERS, name: 'Sub-orders' },
      { to: adminPath.subOrderDetail('KZ-40128-A'), name: 'Sub-order detail' },
      { to: ADMIN_ROUTES.SHIPMENTS, name: 'Shipments' },
      { to: ADMIN_ROUTES.RTO, name: 'Return to origin' },
      { to: ADMIN_ROUTES.RETURNS, name: 'Returns' },
      { to: adminPath.returnDetail('ret-1'), name: 'Return review' },
      { to: ADMIN_ROUTES.CANCELLATIONS, name: 'Cancellations' },
