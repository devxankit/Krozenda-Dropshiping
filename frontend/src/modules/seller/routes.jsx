...
import { VendorRegisterPage } from '../vendor-shared/pages/VendorRegisterPage'
  ...
  return (
    ...
    <TranslationProvider>
      <Routes>
        ...
        {/* Sign-up sits outside the RoleGuard for the obvious reason: nobody
            registering has a session yet. */}
